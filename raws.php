...
<body>
    ...
    <section class="home-section">
        ...
        ?>
            ...
            your current money is <?php echo $user_stats['money'] ?>
            <br>
            <form action="POST" action="functions.php">
        ...
        ?>
            ...
            <br>
            <br>
            <p>cost of creating one oil and natural gas mine is 1000</p>
            <br>
            your current oil and natural gas mines are <?php echo $user_stats['oil and natural gas mine'] ?>
            <br>
            your current money is <?php echo $user_stats['money'] ?>
            <br>
            <form method="POST" action="functions.php">
